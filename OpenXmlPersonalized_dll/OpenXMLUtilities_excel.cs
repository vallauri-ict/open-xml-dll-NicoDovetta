...
namespace OpenXmlPersonalized_dll
{
    ...
    public class OpenXMLUtilities_excel
    {
        public static void CreatePartsForExcel(SpreadsheetDocument document, TestModelList data)
        {
            ...
            WorkbookPart wrkBookP1 = document.AddWorkbookPart();
            GenerateWorkbookPartContent(wrkBookP1);
            WorkbookStylesPart wrkBookStylesP1 = wrkBookP1.AddNewPart<WorkbookStylesPart>("rId3");
            GenerateWorkbookStylesPartContent(wrkBookStylesP1);
            WorksheetPart wrkSheetP1 = wrkBookP1.AddNewPart<WorksheetPart>("rId1");
            GenerateWorksheetPartContent(wrkSheetP1, sheetData);
        }

        private static void GenerateWorkbookPartContent(WorkbookPart wrkBookP1)
        {
            Workbook workBook1 = new Workbook();
            Sheets sheet = new Sheets();
            Sheet sheet1 = new Sheet() { Name = "Sheet1", SheetId = (UInt32Value)1U, Id = "rId1" };
            sheet.Append(sheet1);
            workBook1.Append(sheet);
            wrkBookP1.Workbook = workBook1;
        }

        private static void GenerateWorksheetPartContent(WorksheetPart wrkSheetP1, SheetData sheetData1)
        {
            ...
            wrkSheetP1.Worksheet = worksheet1;
        }

        private static void GenerateWorkbookStylesPartContent(WorkbookStylesPart wrkbookStylesP1)
        {
            ...
            wrkbookStylesP1.Stylesheet = stylesheet1;
        }
